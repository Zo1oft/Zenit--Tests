# Проект по автоматизации тестирования zenit.ru
<a href="https://www.zenit.ru/"><img width="40%" title="Zenit" src="images/logo/Bank_ZENIT.png"></a>
...
- Проверка работы страницы кредитных и дебетовых карт (c PageObjects)
- Проверка работы страницы ИИС (c PageObjects)
